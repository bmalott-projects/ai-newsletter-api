...
2. Interests they want to REMOVE (interests they explicitly say they don't want, or want to stop following)

Guidelines:
- Extract specific, actionable interest topics (e.g., "Python async patterns", "React hooks", "machine learning")
- Be precise: avoid overly broad topics unless explicitly mentioned
- Only include interests in remove_interests if the user explicitly states they want to remove or stop following something
...
Extract the interests from this prompt. Return a JSON object with "add_interests" and "remove_interests" arrays."""
